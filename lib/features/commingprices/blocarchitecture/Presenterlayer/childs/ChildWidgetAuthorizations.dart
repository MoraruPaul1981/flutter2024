...
class ChildWidgetAuthorizations  extends State<WidgetStateful>   implements IntarfaceChildWidgetAuthorizationUsers   {
...
//TODO: переменные
  ...
  Key? key;
  //TODO консруктор
  ChildWidgetAuthorizations({this.key, required this.logger } ) ;
